      ...
      <div className="max-w-[1200px] mx-auto py-6 px-8 flex justify-between items-center">
        ...
        <nav className="flex gap-8">
          ...
          <div className="relative">
            <button
              className="py-2 px-4 border-0 text-base font-medium cursor-pointer transition-all duration-300 rounded-lg bg-transparent text-white/70 hover:text-white hover:bg-white/5 flex items-center gap-2"
